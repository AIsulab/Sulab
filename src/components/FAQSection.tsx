const faqs = [
  {
    ...
    answer:
      "요청서를 등록하면 24시간 이내에 전문 매니저가 연락을 드려 요구사항을 정리하고 다음 단계를 안내해 드립니다.",
  },
  {
    question: "전문가는 어떤 방식으로 검증되나요?",
    answer:
      "기술 역량, 프로젝트 리뷰, 인터뷰를 기반으로 평가 지표를 관리하며 매칭 이후에도 지속적으로 모니터링합니다.",
  },
  {
    question: "계약과 결제는 안전한가요?",
    answer:
      "위시켓의 단계별 대금 보호 시스템을 통해 진척도에 맞춰 대금을 지급하며, 문제 발생 시 매니저가 중재를 지원합니다.",
  },
];
